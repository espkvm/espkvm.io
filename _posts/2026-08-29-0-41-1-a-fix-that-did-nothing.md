...
description: I shipped a WiFi fix and never called the function. The person who reported the bug found the missing line himself. While checking that release I found a crash that had been hiding behind three different symptoms.
